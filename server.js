...
app.post('/api/send-code', async (req, res) => {
  ...
  try {
    await transporter.sendMail({
      from: '"Skaters Shop" <skatedelivery007@gmail.com>',
      to: email,
      subject: 'Votre code de connexion Skaters — ' + code,
      html: '<div style="font-family:Arial;background:#050a14;color:#fff;padding:32px;border-radius:12px;max-width:500px;margin:0 auto"><div style="background:#2563eb;padding:20px;border-radius:8px;text-align:center;margin-bottom:24px"><h1 style="margin:0">Skaters</h1></div><h2 style="color:#2563eb;text-align:center;">Votre code</h2><div style="background:#090f1e;border:2px solid #2563eb;border-radius:14px;padding:24px;text-align:center;margin:20px 0"><span style="font-size:2.5rem;font-weight:900;letter-spacing:0.3em;color:#fff;">' + code + '</span></div><p style="color:#7a90b0;text-align:center;font-size:0.85rem;">Ce code expire dans 10 minutes. Ne le partagez pas.</p><p style="color:#444;font-size:12px;text-align:center;margin-top:24px">© 2026 Skaters.</p></div>'
    });
